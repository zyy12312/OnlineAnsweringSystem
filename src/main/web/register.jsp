                    ...
                    <div class="card-body px-5 py-5">
                        ...
                        <form>
                            ...
                            <div class="text-center">
                                <button type="button" class="btn btn-primary btn-block enter-btn" onclick="signUp()">Sign Up</button>
                            </div>
                        ...
                        <script type="text/javascript">
                            function signUp(){
                                ...
                                var url='/register.do?ID='+id+'&Password='+password+'&UserName='+userName;
                                console.log(url);
